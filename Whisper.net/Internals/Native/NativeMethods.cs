...
namespace Whisper.net.Native
{
    internal static class NativeMethods
    {
        ...
        [DllImport(dllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "whisper_init_from_buffer", CharSet = CharSet.Ansi)]
        ...
        [DllImport(dllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "whisper_init_from_buffer_no_state", CharSet = CharSet.Ansi)]
